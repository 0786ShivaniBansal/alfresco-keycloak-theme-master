...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
        ...
        <link href="${url.resourcesPath}/img/logo.png" rel="icon"/>
        <script>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/sennovatelogo.png" alt="Sennovate">
        </div>
        <div class="box-container">
            <div>
                <p class="application-name">Sennovate Identity Service</p>
            </div>
        <#if realm.password>
            <div>
